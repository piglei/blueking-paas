...
HANDLE = AgentRuntimeHandle(conversation_id=CONVERSATION_ID, base_url="http://runtime.invalid")
...
def dead_handle() -> AgentRuntimeHandle:
    ...
    return AgentRuntimeHandle(conversation_id=CONVERSATION_ID, base_url=f"http://127.0.0.1:{port}")
